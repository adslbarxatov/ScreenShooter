...
namespace ScreenShooter
	...
	public partial class MainForm:Form
		...
		public MainForm ()
			...
			SFDialog.Title = "Укажите путь для сохранения изображения";
			SFDialog.Filter = "Изображение PNG|*.png|Фотография JPEG|*.jpeg|Рисунок BMP|*.bmp|Рисунок GIF|*.gif";
			}
		...
		private void SFDialog_FileOk (object sender, System.ComponentModel.CancelEventArgs e)
			...
			try
				...
				{
				MessageBox.Show ("Не удалось сохранить изображение. Возможно, целевая директория недоступна для записи",
